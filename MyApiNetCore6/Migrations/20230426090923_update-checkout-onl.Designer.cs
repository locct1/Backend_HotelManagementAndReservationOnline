...
namespace MyApiNetCore6.Migrations
{
    ...
    [Migration("20230426090923_update-checkout-onl")]
    partial class updatecheckoutonl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.ClientOffline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.MethodPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ClientOfflineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BookingOnlineId")
                        .IsUnique()
                        .HasFilter("[BookingOnlineId] IS NOT NULL");

                    b.HasIndex("ClientOfflineId");
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.RoomReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.RoomReservationProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RoomRervationId")
                        .IsRequired()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RoomRervationId");

                    b.ToTable("RoomReservationProduct");
                });
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.BookingOnline", b =>
                {
                    ...
                    b.HasOne("MyApiNetCore6.Data.MethodPayment", "MethodPayment")
                        .WithMany("BookingOnlines")
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.Reservation", b =>
                {
                    b.HasOne("MyApiNetCore6.Data.BookingOnline", "BookingOnline")
                        .WithOne("Reservation")
                        .HasForeignKey("MyApiNetCore6.Data.Reservation", "BookingOnlineId");

                    b.HasOne("MyApiNetCore6.Data.ClientOffline", "ClientOffline")
                        .WithMany("Reservations")
                        .HasForeignKey("ClientOfflineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.RoomReservation", b =>
                {
                    b.HasOne("MyApiNetCore6.Data.Reservation", "Reservation")
                        .WithMany("RoomReservations")
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyApiNetCore6.Data.Room", "Room")
                        .WithMany("RoomReservations")
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.RoomReservationProduct", b =>
                {
                    b.HasOne("MyApiNetCore6.Data.Product", "Product")
                        .WithMany("RoomReservationProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("MyApiNetCore6.Data.RoomReservation", "RoomReservation")
                        .WithMany("RoomReservationProducts")
                        .HasForeignKey("RoomRervationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyApiNetCore6.Data.Product", b =>
                {
                    b.Navigation("RoomReservationProducts");
                });
